...
if __name__ == "__main__": 
    ...
    # 0- ON from 1 Jan 2010 
    on_from_0 = datetime(2010, 5, 1, 0, 0, 0)
    ...
    # 8- ON from Sunday 12:20 to 31 Dec 2097
    on_from_8 = off_to_7
    on_to_8 = datetime(2037, 12, 31, 23, 59, 59)
    on_duration_days_8, on_duration_hours_8, on_duration_minutes_8, on_duration_seconds_8 = time_difference(on_from_8, on_to_8)
    
    # 8- OFF from 31 Dec 2097 to 1 Jan 2098
    off_from_8 = on_to_8
    off_to_8 = datetime(2038, 1, 1, 1, 0, 0) 
    ...
    OFF D{off_duration_days_1} H{off_duration_hours_1} M{off_duration_minutes_1} S{off_duration_seconds_1}
    ON D{on_duration_days_2} H{on_duration_hours_2} M{on_duration_minutes_2} S{on_duration_seconds_2}
    OFF D{off_duration_days_2} H{off_duration_hours_2} M{off_duration_minutes_2} S{off_duration_seconds_2}
    ON D{on_duration_days_3} H{on_duration_hours_3} M{on_duration_minutes_3} S{on_duration_seconds_3}
    OFF D{off_duration_days_3} H{off_duration_hours_3} M{off_duration_minutes_3} S{off_duration_seconds_3}
    ON D{on_duration_days_4} H{on_duration_hours_4} M{on_duration_minutes_4} S{on_duration_seconds_4}
    OFF D{off_duration_days_4} H{off_duration_hours_4} M{off_duration_minutes_4} S{off_duration_seconds_4}
    ON D{on_duration_days_5} H{on_duration_hours_5} M{on_duration_minutes_5} S{on_duration_seconds_5}
