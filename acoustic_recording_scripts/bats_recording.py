...
if __name__ == "__main__":
    ...
    # Find today date
    date = datetime.strftime(current_time, '%Y_%m_%d')
    ...
    # Prepare comand
    command = ["sudo", "arecord", "-D", ultrasonic_settings['device'], "-f", ultrasonic_settings['data_format'], "-r", ultrasonic_settings['sample_rate'], "-d", ultrasonic_settings['rec_interval'], full_path]
    ...
    metadata = {
        "ultrasonic_microphone_event_data":{
            "event_ids": {
