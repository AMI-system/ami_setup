...
import json # Used to configure settings for bat recording. Access variables defined in system_config.JSON
...
path_to_file_storage = str(system_variables['bats']['directory_to_save_audio'] + "%s_%s_%s" % (date_and_time.year, date_and_time.month, date_and_time.day)) # e.g. '/media/bird-pi/PiImages/BAT/raw_audio/2023_2_8'
...
file_to_store = str(system_variables['system']['LID'] + "__" + system_variables['system']['SID'] + "__" + system_variables['bats']['HID'] + "__%s_%s_%s__%s_%s_%s.wav" % (date_and_time.year, date_and_time.month, date_and_time.day, date_and_time.hour, date_and_time.minute, date_and_time.second))


## Combine directory and file names into 1 path
full_path = path_to_file_storage + "/" + file_to_store # '/media/bird-pi/PiImages/BAT/raw_audio/2023_2_8/LID_test__SID_test__HID_test__2023_2_8__17_42_7.wav'
...
# -d 60 is the duration, here 60 seconds (test using 3 seconds)
...
proc_args = ['arecord', '-D', system_variables['bats']['device_name'], '-c', system_variables['bats']['number_of_channels'], '-d', system_variables['bats']['duration'], '-r', system_variables['bats']['sampling_rate'], '-f', system_variables['bats']['data_format'], '-t', system_variables['bats']['file_type'], '-V', system_variables['bats']['recording_type'], '-v', full_path]
